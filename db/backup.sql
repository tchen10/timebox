...
----
--
--INSERT INTO item VALUES (9, 'If you''re looking to develop your in-line skills or simply want to roll over any obstacle with ease, then this economically priced, 29er frame will keep you riding with speed and control.', '2011 Access XCL 9er', 179.99, 'FRAME', 521, 'no-image-available.jpg');
--INSERT INTO item VALUES (7, 'Get ready to be impressed. With a fit and finish that''s nearly flawless, this 7005 butted aluminum frameset is in a class of its own when it comes to high-end performance at a great value.', 'Scattante XRL Comp Road Bike', 289.99, 'FRAME', 787, 'no-image-available.jpg');
--INSERT INTO item VALUES (6, 'Fuji''s Altamira CX 1.0 cyclocross frameset is the perfect platform for building up the cross bike of your dreams.', 'Fuji Altamira CX 1.0 Cyclocross', 2599.99, 'FRAME', 432, 'no-image-available.jpg');
--INSERT INTO item VALUES (12, 'Replacement alloy derailleur hanger for Access XCL frames. ', 'Derailleur Hanger for Access XCL and XCL 29er Frames', 10.00, 'ACCESSORIES', 1010, 'no-image-available.jpg');
--INSERT INTO item VALUES (11, 'Shimano''s successful introduction of Di2 digital electronic shifting in its Dura-Ace group heralded a new era of shifting performance for the early adopters who jumped in with both feet.', 'Shimano Ultegra Di2 Upgrade Kit', 1299.99, 'ACCESSORIES', 599, 'no-image-available.jpg');
--INSERT INTO item VALUES (13, 'Frame protection at its best! Small: Standard Large: Jumbo ', 'Lizard Skins Chainstay Guard', 7.99, 'ACCESSORIES', 319, 'no-image-available.jpg');
--INSERT INTO item VALUES (8, 'If you crave simplicity in your cycling life -- but like to express your individuality -- building up your own, customized single-speed road bike could well be the answer. And the Ascent single-speed road bike frame is a great place to start.', 'Ascent Single-Speed Road Bike', 89.99, 'FRAME', 1210, 'no-image-available.jpg');
--INSERT INTO item VALUES (10, 'If fast and furious is how you like to ride, then this winning cyclocross frameset is exactly what you need.', 'Scattante XRL Cyclocross Frame', 279.99, 'FRAME', 537, 'no-image-available.jpg');
--
--
----
